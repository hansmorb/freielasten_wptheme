...
$postGrid = create_postgrid_from_posts(get_post_by_category_and_kupplung('anhaenger',$kupplungen_checked_values));
if ($postGrid != False) {?>
<button class="accordion"><b><i class="fas fa-link"></i> Anhänger und Zubehör</b> </button>
<div class="panel">
	<p>
		<?php	 ?>
				<h3>
